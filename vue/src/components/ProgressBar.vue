<template>
    <div class="container">
        <div class="next">
            <button><img src="../assets/arrow(6) white.svg" alt="arrow"><span>سوال بعدی</span></button>
        </div>
        <div class="progress">
            <div class="completed">
                <div class="circle">
                    <div class="tooltip">
                        <span>29% تکمیل شده</span>
                        <div class="arrow"></div>
                        <span>پرسش 25/3</span>
        ...
        <div class="back">
            <button><img src="../assets/arrow(6) blue.svg" alt="arrow"></button>
        </div>
    </div>
</template>
